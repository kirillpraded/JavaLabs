package by.bntu.fitr.poisit.praded.javalabs.lab05.task01.view;
...
public class FirstTaskView {
    ...
    public static void welcomeMessage() {
        System.out.println("Program counts number of digits in a number");
    }
    ...
    public static void printResult(int amountOfDigits, int number) {
        System.out.println("There are " + amountOfDigits + " digits in " + number + ".");
